  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-3 right-3 text-parchment-400 hover:text-parchment-100"
        >
          <X size={16} />
        </button>
        ...
        <button
          onClick={handleCopy}
          className={`mt-4 flex items-center gap-2 font-mono text-xs px-4 py-2 border transition ${
            copied
    ...
    <>
      ...
      >
        <div className="p-3 sm:p-5">
          ...
          <div className="flex flex-wrap items-start gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0 w-full">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-2">
                <span className="font-mono text-xs text-parchment-400/60 border px-1.5 py-0.5 rounded-sm">
              ...
              {/* TITLE */}
              <h3 className="font-display text-lg sm:text-xl leading-snug text-parchment-100 mb-1.5 break-words whitespace-normal w-full min-w-0 [word-break:normal] hyphens-auto">
                {pub.title}
              </h3>
          ...
          {/* ACTIONS */}
          <div className="flex flex-wrap items-center gap-3 mt-4 pt-3 border-t border-noir-600/60 min-w-0">

            <button
              onClick={() => setExpanded(!expanded)}
              className="flex items-center gap-1 text-xs font-mono text-parchment-400 hover:text-gold-400"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 text-xs font-mono text-parchment-400 hover:text-gold-400 border-l pl-3"
            >
            ...
            {expanded && (
              ...
              >
                <div className="mt-4 pt-4 border-t border-gold-500/10 space-y-4">
                  ...
                  <div>
                    <p className="font-mono text-xs text-gold-400/60 tracking-normal sm:tracking-widest uppercase mb-2">
                      Abstract
                    </p>
