...
const stats = [
  ...
  { icon: <Award size={16} />,      value: 2,  suffix: '',  label: 'IEEE Conferences', sub: 'ICCA & ICBDT 2025' },
  { icon: <TrendingUp size={16} />, value: 4,  suffix: '+', label: 'Journals',         sub: 'Springer, PLOS ONE, MDPI' },
]
